<i18n lang='yaml'>
  ar:
    slides:
      ...
      -
        title: طلب الإحاطة
        content: يقدم طلب إحاطة إلى رئيس مجلس الوزراء، أو أحد نوابه، أو أحد الوزراء، أو نوابهم، يحيطه علما بأمر له أهمية عامة ويكون داخلا فى اختصاص من يوجه إليه بهدف إحاطته علما بمشكلة ما لا يعلمها   مما يترتب عليه حلها من قبل المؤول
        image:
